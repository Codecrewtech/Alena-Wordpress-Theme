            ...
            <div class="col-sm-8 col-md-8">
                ...
                <article class="blog-item blog-single">
                    ...
                    <div class="entry-date">
                        <span><?php esc_html_e('Page Not Found', 'katharine'); ?></span>
                    </div>

                    <h1 class="post-title">
                        <?php echo wp_kses( __('Sorry, The page You are searching<br>was not found!', 'katharine'), array('br'=>array()) ); ?>
                    </h1>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1">
                                <form class="search_form" action="<?php echo esc_url(home_url('/')); ?>" method="get">
                                    <input type="text" name="s" placeholder="<?php esc_attr_e('What You are Searching for?', 'katharine'); ?>">
